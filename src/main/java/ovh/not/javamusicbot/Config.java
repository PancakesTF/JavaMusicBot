...
public class Config {
    ...
    public final boolean patreon = false;
    final String token = null;
    public final Set<String> owners = null;
    public final Set<String> managers = null;
    final String regex = null;
    final String prefix = null;
    final String game = null;
    public final String invite = null;
    public final String about = null;
    final String join = null;
